 ...
 */
public class AddGroupMembersAdapter  extends RecyclerView.Adapter<RecyclerView.ViewHolder>{
    ...
    public AddGroupMembersAdapter(Activity activity
            ,ArrayList<Contacts> contactList,
                                  ArrayList<Boolean> selectedArrayList
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, final int position) {
        ...
        if (holder instanceof VHItem) {
            ...
            vhItemHolder.contactName.setText(contactList.get(position).name);
            vhItemHolder.phoneNumber.setText(contactList.get(position).number);
