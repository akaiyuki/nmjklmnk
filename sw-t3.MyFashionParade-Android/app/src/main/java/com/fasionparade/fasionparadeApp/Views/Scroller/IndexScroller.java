package com.fasionparade.fasionparadeApp.Views.Scroller;
...
import com.fasionparade.fasionparadeApp.Models.Adapters.ContactListHelperAdapter;

// taken from https://github.com/woozzu/indexableListView IndexScroller1
...
public class IndexScroller {
	...
	public void drawCurrentSection(Canvas canvas){
		if (mCurrentSection >= 0)
		{
			...
			//Log.i("IndexScroller1", "current section: " + mCurrentSection);
	...
	public void setAdapter(Adapter adapter) {
		...
		else if(adapter instanceof ContactListHelperAdapter){
			ContactListHelperAdapter c = (ContactListHelperAdapter)adapter;
