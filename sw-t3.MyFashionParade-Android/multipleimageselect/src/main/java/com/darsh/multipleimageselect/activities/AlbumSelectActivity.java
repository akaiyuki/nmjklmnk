...
public class AlbumSelectActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Constants.userType = intent.getStringExtra("UserType");
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        Log.e("Entry","Activate"+Constants.REQUEST_CODE+"///"+resultCode);
        if (requestCode == Constants.REQUEST_CODE && resultCode == RESULT_OK && data != null) {
            Log.e("Entry","if Activate");
            setResult(RESULT_OK, data);
            finish();
        }else if(requestCode == Constants.REQUEST_CODE && resultCode == RESULT_CANCELED && data != null){
            Log.e("Entry","else Activate");
