...
import com.darsh.multipleimageselect.helpers.AlertDialogManager;
    ...
    private void toggleSelection(int position) {
        if (!images.get(position).isSelected && countSelected >= Constants.limit) {
            if(usertype.equals("0")) {
                showAlertDialog(ImageSelectActivity.this, "Upgrade MFP",
                        String.format(getString(R.string.limit_exceeded), 2), false);
            }
